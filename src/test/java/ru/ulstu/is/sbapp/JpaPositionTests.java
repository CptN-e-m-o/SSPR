...
public class JpaPositionTests {
    ...
    void testPositionReadNotFound() {
        positionService.deleteAllPositions();
        Assertions.assertThrows(PositionNotFoundException.class, () -> positionService.findPosition(-1L));
    }
    ...
    void testTariffAddClient(){
        ...
        final Position position = positionService.addPosition("Test", 22.2);
        //tariffService.addClientToTariff(position, worker);
